...
test_that("Verify split_hc length of train: test less than train", {
  split = split_hc(data$x, 0.8)
...
test_that("Verify split_hc length of train: test greater than train", {
  split = split_hc(data$x, 0.2)
  train_len = length(split$train)
